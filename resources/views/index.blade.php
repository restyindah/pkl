            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="viralnewsNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="index.html"><img src="{{('assets/frontend/img/core-img/logo.png')}}" alt="Logo"></a>
                            ...
                            <div class="row no-gutters">
                                <div class="col-12 col-lg-8">
                                    ...
                                    <div class="welcome-post">
                                        <img src="{{('assets/frontend/img/bg-img/bg1.jpg')}}" alt="">
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="welcome-posts--">
                                        ...
                                        <div class="welcome-post style-2">
                                            <img src="{{('assets/frontend/img/bg-img/bg2.jpg')}}" alt="">
                                        ...
                                        <!-- Welcome Post -->
                                        <div class="welcome-post style-2">
                                            <img src="{{('assets/frontend/img/bg-img/bg3.jpg')}}" alt="">
                ...
                <div class="col-12 col-lg-4">
                    <div class="sidebar-area">
                        ...
                        <div class="add-widget mb-70">
                            <a href="#"><img src="{{('assets/frontend/img/bg-img/add.png')}}" alt=""></a>
                        </div>
